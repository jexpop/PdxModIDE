...
**Versión actual**: 1.5.4 (ver `CHANGELOG_ES.md`, `CHANGELOG_EN.md`, `CHANGELOG_CA.md`). Solution: `PdxModIDE.sln` (9 proyectos).
...
*Generado: 2026-07-31 | Proyecto: PdxModIDE | Versión: 1.5.4 | Stack: .NET 8 / WPF / SkiaSharp 3.116.1 / System.Text.Json*
