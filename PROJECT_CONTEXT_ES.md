...
**Versión actual**: 1.3.1 (ver `CHANGELOG_ES.md`, `CHANGELOG_EN.md`, `CHANGELOG_CA.md`). Solution: `PdxModIDE.sln` (9 proyectos).
...
*Generado: 2026-07-19 | Proyecto: PdxModIDE | Versión: 1.3.1 | Stack: .NET 8 / WPF / SkiaSharp / System.Text.Json*
