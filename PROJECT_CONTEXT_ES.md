...
**Versión actual**: 1.4.12 (ver `CHANGELOG_ES.md`, `CHANGELOG_EN.md`, `CHANGELOG_CA.md`). Solution: `PdxModIDE.sln` (9 proyectos).
...
*Generado: 2026-07-24 | Proyecto: PdxModIDE | Versión: 1.4.12 | Stack: .NET 8 / WPF / SkiaSharp 3.116.1 / System.Text.Json*
