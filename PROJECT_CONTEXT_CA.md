...
**Versió actual**: 1.4.13 (veure `CHANGELOG_CA.md`, `CHANGELOG_ES.md`, `CHANGELOG_EN.md`). Solution: `PdxModIDE.sln` (9 projectes).
...
*Generat: 2026-07-26 | Projecte: PdxModIDE | Versió: 1.4.13 | Stack: .NET 8 / WPF / SkiaSharp 3.116.1 / System.Text.Json*
