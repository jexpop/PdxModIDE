...
**Versió actual**: 1.3.2 (veure `CHANGELOG.md`). Solution: `PdxModIDE.sln` (9 projectes).
...
*Generat: 2026-07-19 | Projecte: PdxModIDE | Versió: 1.3.2 | Stack: .NET 8 / WPF / SkiaSharp / System.Text.Json*
