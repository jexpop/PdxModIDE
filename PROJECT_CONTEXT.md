...
**Current version**: 1.8.3 (see the `Changelog/` folder, one file per minor version). Solution: `PdxModIDE.sln` (10 projects — added BookmarksTab + BookmarkLoader; HistoryTab now bookmark-driven date with ViewSelector at top).
...
*Generated: 2026-09-20 | Project: PdxModIDE | Version: 1.8.3 | Stack: .NET 8 / WPF / SkiaSharp 3.116.1 / System.Text.Json*
