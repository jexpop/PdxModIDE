...
**Current version**: 1.6.11 (see the `Changelog/` folder, one file per minor version). Solution: `PdxModIDE.sln` (9 projects).
...
*Generated: 2026-08-11 | Project: PdxModIDE | Version: 1.6.11 | Stack: .NET 8 / WPF / SkiaSharp 3.116.1 / System.Text.Json*
