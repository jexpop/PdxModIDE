...
**Current version**: 1.6.19 (see the `Changelog/` folder, one file per minor version). Solution: `PdxModIDE.sln` (9 projects).
...
*Generated: 2026-08-17 | Project: PdxModIDE | Version: 1.6.19 | Stack: .NET 8 / WPF / SkiaSharp 3.116.1 / System.Text.Json*
