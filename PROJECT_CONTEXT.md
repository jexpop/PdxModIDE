...
**Versión actual**: 1.1.9 (ver `CHANGELOG.md`). Solution: `PdxModIDE.sln` (9 proyectos).
...
*Generado: 2026-07-18 | Proyecto: PdxModIDE | Versión: 1.1.9 | Stack: .NET 8 / WPF / SkiaSharp / System.Text.Json*